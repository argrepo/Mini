...
<div class="col-md-12" style="padding:0px;">
	...
	<c:url value="/commonMappings" var="url"/>
	...
	<form:form modelAttribute="defaultMappingInfo" action="${url}">
			<c:if test="${defaultMappingInfo.pageMode == 'display' }">
				<input type="hidden" value="${url}/${defaultMappingInfo.clientId}" id="url">
				...
				<c:if test="${defaultMappingInfo.templateId != '0' && defaultMappingInfo.templateId != null}">
					<c:choose>
						...
						<c:otherwise>
									...
									<c:choose>
										...
										<c:otherwise>
											<table class="table table-striped table-bordered tablebg " id="dlMasterTable">
												<thead>
													<tr>
														<th><spring:message code="anvizent.package.label.sNo"/><input type="checkbox" name="selectAll" class="selectAllDLs"></th>
												...
												<% int i = 1; %>
													<c:forEach items="${dlInfo}" var="dLInfo" varStatus="loop">
														<tr>
															<td>
																<%= i%>
																<input type="checkbox" class="dLs" name="dLInfo[${loop.index}].dL_id" value="${dLInfo.dL_id}" data-industryid="${dLInfo.industry.id}">
							...
							<div class="col-sm-6 main-covering hidden">	
									...
									<c:choose>
										...
										<c:otherwise>
											<table class="table table-striped table-bordered tablebg row" id="ConnectorTable">
												...
												<tbody>
														<tr>
														<form:hidden path="bucketId" value="bucketId"/>
