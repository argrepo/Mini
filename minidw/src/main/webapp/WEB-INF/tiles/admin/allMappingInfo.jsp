		 	...
		 	<c:if test="${allMappingInfoForm.clientId != null && allMappingInfoForm.clientId != '0' }">
				...
				allMappingInfoForm.numberOfCurrencies == 0 }">
					<div class="row form-group col-sm-6">
						<a href="<c:url value="/commonMappings/${allMappingInfoForm.clientId}"/>" class="btn btn-sm btn-primary defaultMappings"><spring:message code="anvizent.package.label.DefaultMappings"/></a>
					</div>
				</c:if>
			</c:if>
	</form:form>
