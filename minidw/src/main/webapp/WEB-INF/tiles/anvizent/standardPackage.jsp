														...
														<c:choose>
															   <c:when test="${dLInfo.schedule.scheduleId == 0}">
															     <button type='button'
																	...
																	data-industryid="${dLInfo.industry.id}" data-scheduleId ='<c:out value="${dLInfo.schedule.scheduleId}"/>' data-reSchedule="reRun">
															  ...
															  <c:if test="${not empty dLInfo.schedule.scheduleRecurrence}">
															    ...
															    <c:if test="${dLInfo.schedule.scheduleType != 'UNSCHEDULED' }">
																	 <button type='button'
																		 ...
																		 data-reSchedule="reRun" title="<c:out value="${test}"/>">
																	 ...
																	 <c:if test="${dLInfo.schedule.scheduleRecurrence != 'once'}">
																		<button type='button'
																			...
																			data-dLId='<c:out value="${dLInfo.dL_id}"/>' data-dLName='<c:out value="${dLInfo.dL_name}"/>'
																			data-packgeid="0" data-scheduleId ='<c:out value="${dLInfo.schedule.scheduleId}"/>'>
														     ...
														     <a class='btn btn-primary btn-xs' href ="<c:url value="/adt/standardpackage/executionResults/${dLInfo.dL_id}?dlName=${dLInfo.dL_name}"/>">
