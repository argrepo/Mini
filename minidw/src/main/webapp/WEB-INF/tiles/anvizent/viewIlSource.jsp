							  ...
							  <c:if  test="${!iLConnectionMapping.joinWebService}">
                               <div class='row form-group'>
								...
								<div class='row form-group'>
									...
									<div class='col-sm-1 updateFlat' style="display:none">
										<button type="button" style="float:right;margin-top:-6px;" class="btn btn-primary btn-sm updateFlatDetails" data-mappingDbId="<c:out value="${iLConnectionMapping.connectionMappingId}"/>"><spring:message code = "anvizent.package.button.update"/></button>
									</div>
									<div class='col-sm-1' >
										<button type="button" style="float:right;margin-top:-6px;"  class="btn btn-primary btn-sm editFlatDetails"><spring:message code="anvizent.package.label.edit" /></button>
									</div>
								</div>
								...
								<div class='row form-group '>
									...
									<div class='col-sm-8' >
										<input type="text" class="form-control" disabled="disabled" title="<c:out value="${iLConnectionMapping.webService.url}"/>" value="<c:out value="${iLConnectionMapping.webService.url}"/>">
									</div>
								</div>
								 </c:if>
							  <c:if  test="${iLConnectionMapping.joinWebService}">
							  <div class="joinWsApiInfoDiv">
                               <div class='row form-group'>
								...
								<div class='row form-group '>
									...
									<div class='col-sm-8' >
										 <textarea class="form-control iLquery"  title="<c:out value="${iLConnectionMapping.webserviceJoinUrls}"/>" id="iLqueryTextArea<c:out value="${increment.index}"/>"  rows="6" disabled="disabled"><c:out value="${iLConnectionMapping.webserviceJoinUrls}"/></textarea>
									</div>
								</div>
								<div class='row form-group'>
