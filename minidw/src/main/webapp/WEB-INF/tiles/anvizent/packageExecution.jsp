					         ...
					         <c:when test="${not empty packageExecutionList}">
					            <c:forEach items="${packageExecutionList}" var="packageExecutionMap" varStatus="index">
														<tr>
															...
															<%-- <td>${packageExecutionMap.packageId}</td> --%>
															...
															<%-- <td>${packageExecutionMap.runType}</td> --%>
															 ...
															 <%-- <c:choose>
															  <c:when test="${packageExecutionMap.uploadStatus != 'IGNORED'}"> --%>
															 ...
															 <%--  </c:when>
														 		  <c:otherwise>
															  <td>${packageExecutionMap.uploadStatus}</td>
															  </c:otherwise>
															 </c:choose> --%>
															 ...
															 <c:when test="${empty packageExecutionMap.executionStatus }">
															  ...
															  <c:when test="${packageExecutionMap.druidStatus != 'IGNORED'}">
														    	<td>${packageExecutionMap.druidStatus}<br><%-- <a href="#" data-executionId='${packageExecutionMap.executionId}' data-uploadOrExecution='druidStatus' id="executionStatusInfo" style="text-transform: capitalize;">Info</a> | --%>
