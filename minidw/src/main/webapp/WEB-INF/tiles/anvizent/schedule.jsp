						 ...
						 <tbody>
							...
							<c:forEach items="${packageListForScheduling}" var="packageForScheduling" varStatus="index">
							 <tr>
								...
								<c:choose>
									<c:when test="${packageForScheduling.isScheduled == false }">
										<td><a href="#" class='schedulePackage schedulePackageId${packageForScheduling.packageId}' data-packgeId='<c:out value="${packageForScheduling.packageId}"/>' data-packagetype="<c:out value="${packageForScheduling.isStandard ?'standard':'custom' }"/>"
										 data-packgeName='<c:out value="${packageForScheduling.packageName}"/>'
										 data-isClientDbTables='<c:out value="${packageForScheduling.isClientDbTables}"/>'										 
									...
									<c:otherwise>
										...
										<c:if test="${ packageForScheduling.scheduleType == 'UNSCHEDULED' }">
											<a href="#" class='schedulePackage tool schedulePackageId${packageForScheduling.packageId}' data-packgeId='<c:out value="${packageForScheduling.packageId}"/>' data-scheduleId = '<c:out value="${packageForScheduling.scheduleId}"/>' data-packagetype="<c:out value="${packageForScheduling.isStandard ?'standard':'custom' }"/>"
										...
										<c:if test="${ packageForScheduling.scheduleType != 'UNSCHEDULED' }">
											<a href="#" class='schedulePackage tool schedulePackageId${packageForScheduling.packageId}' data-packgeId='<c:out value="${packageForScheduling.packageId}"/>' data-scheduleId = '<c:out value="${packageForScheduling.scheduleId}"/>' data-packagetype="<c:out value="${packageForScheduling.isStandard ?'standard':'custom' }"/>"
											 ...
											 data-isClientDbTables='<c:out value="${packageForScheduling.isClientDbTables}"/>'
											  ...
											  <a  href="#" 
											  class='unSchedulePackage tool schedulePackageId${packageForScheduling.packageId}'  
								...
								<td>
										<a href ="<c:url value="/adt/package/packageExecute/${packageForScheduling.packageId}?packageName=${fn:escapeXml(packageForScheduling.packageName)}"/>"><spring:message code="anvizent.package.label.viewExecutionResults"/></a>										
								</td>
							</tr>	
							</c:forEach>
