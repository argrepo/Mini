...
public class CommonMappingController {
	...
	public ModelAndView getDefaultTemplatesInfo(@PathVariable("client_id") int client_id, HttpServletRequest request, HttpServletResponse response,
	...
	public ModelAndView getDefaultMappingInfoByTemplate(@PathVariable("client_id") int client_id, HttpServletRequest request, HttpServletResponse response,
			ModelAndView mv, @ModelAttribute("defaultMappingInfo") DefaultMappingInfoForm defaultMappingInfo, RedirectAttributes redirectAttributes,
			Locale locale) {
