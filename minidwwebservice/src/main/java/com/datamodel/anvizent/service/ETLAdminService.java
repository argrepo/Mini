 ...
 *
 */
public interface ETLAdminService {
	...
	void deleteClientSourceDetails(int id, JdbcTemplate clientAppDbJdbcTemplate);
	...
	int addNewILAndXrefTemplateInfo(ClientData clientData, JdbcTemplate clientAppDbJdbcTemplate);

	int updateILAndXrefTemplateInfo(ClientData clientData, JdbcTemplate clientAppDbJdbcTemplate);
	...
	int createWebService(WebService webservice, JdbcTemplate clientAppDbJdbcTemplate);
	...
	int updateWebServicesById(WebService webservice, JdbcTemplate clientAppDbJdbcTemplate);
	...
	int saveDefaultTemplateMasterMappingData(int templateId, String mappingType, List<Integer> masterIds, Modification modification, JdbcTemplate clientAppDbJdbcTemplate);
	...
	int clientsInstantScriptExecution(TableScriptsForm tableScriptsForm, JdbcTemplate jdbcTemplate);
	

	List<TableScriptsForm> getClientsInstantScriptExecution(JdbcTemplate clientAppDbJdbcTemplate);

	int instantscriptExecutionOfClient(TableScriptsForm tableScriptsForm,JdbcTemplate jdbcTemplate);
	
	List<TableScriptsForm> getInstantScriptExecutionOfClient(int client_instant_id,JdbcTemplate clientAppDbJdbcTemplate);
	...
	String executeInsertScripts(MultiClientInsertScriptsExecution multiClientInsertScriptsExecution,Connection connection,JdbcTemplate commonJdbcTemplate,String clientId);
