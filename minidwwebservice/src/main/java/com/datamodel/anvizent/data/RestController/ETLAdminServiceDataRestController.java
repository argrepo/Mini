...
public class ETLAdminServiceDataRestController {
	...
	public DataResponse createContextParameter(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("parameterName") String parameterName, HttpServletRequest request, Locale locale) {
		int count = 0;
		...
		try {
			...
			if (parameterName != null) {
				...
				existContextParameter = etlAdminService.getExistContextParameter(parameterName,
				...
				if (existContextParameter == 0) {
					...
					message.setText(messageSource.getMessage(
							"anvizent.message.success.text.ContextParameterCreatedsuccessfully", null, locale));
					...
					message.setText(messageSource
							.getMessage("anvizent.message.success.text.ContextParameterAlreadyExist", null, locale));
					messages.add(message);
					dataResponse.setMessages(messages);
				}
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.parametershouldNotBeEmpty", null,
						locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			...
			// packageService.logError(t, request);
			LOGGER.error("error while createContextParameter() ", t);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToCreateContextParameter", null,
					locale));
			messages.add(message);
			dataResponse.setMessages(messages);
	...
	public DataResponse createContextParams(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ContextParameter contextParameter, HttpServletRequest request, Locale locale) {
		int count = 0;
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (existContextParameter > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.ContextParameterCreatedsuccessfully", null, locale));
			} else {
				dataResponse.setObject(count);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToCreateContextParameter",
						null, locale));
			}
			...
			message.setText(messageSource.getMessage("anvizent.message.success.text.ContextParameterAlreadyExist", null,
					locale));
		} /*
			 ...
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToCreateContextParameter",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getContextParameters(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (contextParameters != null && contextParameters.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.unableToRetrieveContextParameters", null, locale));
			}
		} catch (Throwable t) {
			// packageService.logError(t, request);
			LOGGER.error("error while getContextParameters() ", t);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveContextParameters",
					null, locale));
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getContextParameterById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("id") Integer id, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getContextParamValue(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource
					.getMessage("anvizent.message.error.text.unableToRetrieveContextParameterDetails", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateContextParams(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ContextParameter contextParameter, HttpServletRequest request, Locale locale) {
		int count = 0;
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			if (existContextParameter > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.ContextParameterUpdatedsuccessfully", null, locale));
			} else {
				dataResponse.setObject(count);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
	...
	public DataResponse getIlInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @PathVariable("dlId") String dlId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(
					messageSource.getMessage("anvizent.message.error.text.unableToRetrieveIlInfo", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveEtlDlIlMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody ETLAdmin eTLAdmin,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse uploadIlOrDlFiles(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, HttpServletRequest request, Locale locale,
			@RequestParam("files") MultipartFile[] multipartFiles,@RequestParam(value="isCommonJob",required=false) String isCommonJob) {
		...
		try {
			...
			LOGGER.error("error while uploadIlOrDlFiles() ", e);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToUploadJobFiles", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
		} */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse createDl(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody ETLAdmin eTLAdmin, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			packageService.logError(e, request);
			LOGGER.error("error while createDl() ", e);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToCreateDL", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
		} */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse saveClientAndDls(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody ETLAdmin eTLAdmin,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getDlClientidMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String userId, @PathVariable("Id") String Id,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveMappedDLs", null, locale));
		}*/ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
		messages.add(message);
	...
	public DataResponse getVerticalMappedDLsByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String userId,
			@PathVariable("client_id") String client_id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveDLsList", null, locale));
		}*/ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
		messages.add(message);
	...
	public DataResponse getClientSourceDetails(@PathVariable(Constants.PathVariables.CLIENT_ID) String userId, @PathVariable("Id") String Id,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			packageService.logError(e, request);
			LOGGER.error("",e);
			LOGGER.error("error while getClientSourceDetails() ", e);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveClientSourceDetails", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
		}*/ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getDLData(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @PathVariable("dl_id") int dlId, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			packageService.logError(e, request);
			LOGGER.error("",e);
			LOGGER.error("error while getILData() ", e);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveDlInfo", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
	...
	public DataResponse updateDL(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody ETLAdmin eTLAdmin, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			packageService.logError(e, request);
			// LOGGER.error("",e);
			LOGGER.error("error while updateIL() ", e);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(messageSource.getMessage("anvizent.message.error.text.unableToUpdateDL", null, locale));
			messages.add(message);
			dataResponse.setMessages(messages);
		} */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse updateFileSettings(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody FileSettings fileSettings, HttpServletRequest request, Locale locale) {
		int count = 0;
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (count > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.MaxFileSizeUpdated", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.maxFileSizeUpdationFailed", null,
						locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "error while updateFileSettings() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToUpdateMaxFileSize", null,
	...
	public DataResponse deleteIL(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("il_id") int ilId, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		int count = 0;
		...
		try {
			...
			if (count > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.errorWhileDeleingIL", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception e) { packageService.logError(e, request); //
			 * LOGGER.error("",e); LOGGER.error("error while deleteIL() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToDeleteIL", null, locale));
	...
	public DataResponse deleteDL(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("dl_id") int dlId, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		...
		try {
			...
			if (count > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.errorWhileDeleingDL", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception e) { packageService.logError(e, request); //
			 * LOGGER.error("",e); LOGGER.error("error while deleteDL() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToDeleteDL", null, locale));
			 * messages.add(message); dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getTemplate(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, Locale locale,
	...
	public DataResponse uploadILAndXrefTemplate(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestParam("iLTemplate") MultipartFile iLTemplateFile,
			@RequestParam(value = "xrefTemplate", required = false) MultipartFile xrefTemplateFile,
			@RequestParam("iLName") String iLName, @RequestParam("iLID") String ilID,
		...
		try {
			...
			if (iLTemplateFile != null) {
				...
				// get file headers
				List<String> iL_headers = fileService.getHeadersFromFile(iLTempFile.getAbsolutePath(), flatFileType,
						delimeter, null);
			...
			if (!isSameAsIL) {
				...
				if (xrefTemplateFile != null) {
					...
					// get file headers
					List<String> xrefHeaders = fileService.getHeadersFromFile(xrefTempFile.getAbsolutePath(),
					...
					if (xrefHeaders.size() > 0) {
						if (xrefHeaders.size() == 1 && xrefHeaders.get(0).length() == 0) {
							...
							message.setText(messageSource.getMessage("anvizent.message.validation.text.fileIsEmpty",
									null, locale));
							messages.add(message);
							dataResponse.setMessages(messages);
							return dataResponse;
			...
			if (isSameAsIL && iLTemplateFile.getSize() > 0) {
				...
				if (StringUtils.isNotBlank(iLTemplateDir) && StringUtils.isNotBlank(xrefTemplateDir)) {
					...
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
					message.setText(messageSource
							.getMessage("anvizent.message.success.text.templateUploadedSuccessfully", null, locale));
				}
				...
				if (StringUtils.isNotBlank(iLTemplateDir) && StringUtils.isNotBlank(xrefTemplateDir)) {
					...
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
					message.setText(messageSource
							.getMessage("anvizent.message.success.text.templatesUploadedSuccessfully", null, locale));
				}
			}
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while uploadILAndXrefTemplate() ", e);
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		} finally {
	...
	public DataResponse getTopErrorLog(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, Locale locale,
			HttpServletRequest request) {
		...
		try {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveLogs", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse searchClientErrorLog(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.noErrorsFound", null, locale));
			 * messages.add(message); dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse createWebService(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (webserviceList != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.unableToSaveWebservice", null, locale));
			}
			messages.add(message);
			dataResponse.setMessages(messages);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToSaveWebservice", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse createNewVertical(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Industry industry, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			...
			if (create != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.verticalCreatedSuccesfully",
						null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.unableToCreateVertical", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			message.setText(messageSource.getMessage("anvizent.message.validation.text.verticalNameAlreadyExist", null,
					locale));
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while createNewVertical() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.fail.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToCreateVertical", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getExistingVerticals(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveVerticalList", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getActiveVerticals(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while getActiveVerticals() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveVerticalList", null,
	...
	public DataResponse getVerticalDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (industryDetails != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.verticalDetailsNotFound", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error getVerticalDetailsById() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveVerticalDetails",
	...
	public DataResponse updateVerticalById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Industry industry, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			if (update != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.verticalUpdatedSuccesfully",
						null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileUpdateVertical", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error updateVerticalById() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.fail.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.validation.text.unableToUpdateVertical", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getExistingkpis(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error updateVerticalById() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveKpisList", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse createNewKpi(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Kpi kpi, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		...
		try {
			...
			if (create != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.kpiCreatedSuccesfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.KpiCreationFailed", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			message.setText(
					messageSource.getMessage("anvizent.message.validation.text.kpiNameAlreadyExist", null, locale));
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error createNewKpi() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.fail.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToCreateKpis", null, locale));
			 * }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getKpiDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (kpiDetails != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.kpiDetailsNotFound", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveKpisDetails", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse updateKpiById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Kpi kpi, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			if (update != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.kpiUpdatedSuccesfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileUpdateKpi", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error updateKpiById() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.fail.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToUpdateKpis", null, locale));
			 * }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getExistingILsInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getILInfoById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("iLId") String iLId, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		messages.add(message);
	...
	public DataResponse getClientSpecificILInfoById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("iLId") String iLId, @RequestParam("client_id") String client_id, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse updateILDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ETLAdmin eTLAdmin, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (updateILInfo > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.iLUpdatedSuccesfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileUpdateILInfo", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			message.setText(
					messageSource.getMessage("anvizent.message.validation.text.iLNameAlreadyExist", null, locale));
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToUpdateIlInfo", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse createNewIL(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ETLAdmin eTLAdmin, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (createIlId > 0 || saveContextParams > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(
						messageSource.getMessage("anvizent.message.success.text.IlCreatedSuccesfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileSavingILInfo", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while createNewIL() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToSaveIlInfo", null, locale));
			 * }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getVerticalsByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<Industry> verticals = etlAdminService.getVerticalsByClientId(Integer.parseInt(client_Id),
					clientAppDbJdbcTemplate);
			...
			if (verticals != null && verticals.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileGettingVerticals", null,
						locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingVerticals", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveClientVerticalMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientData clientData, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			clientData.setModification(modification);
			int update = 0;
			etlAdminService.deleteClientVerticalMappingById(Integer.parseInt(clientData.getUserId()),
					clientAppDbJdbcTemplate);
			// if(delete > 0){
			update = etlAdminService.saveClientVerticalMapping(clientData, clientAppDbJdbcTemplate);
			etlAdminService.deleteClientVerticalMappedDLsByClientId(Integer.parseInt(clientData.getUserId()),
					clientAppDbJdbcTemplate);
			// }
			if (update > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.clientVerticalMappingSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientVerticalMapping",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getAllDatabases(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (databases != null && databases.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileGettingDatabases", null,
						locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingDatabases", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getDatabasesByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<Database> databases = etlAdminService.getDatabasesByClientId(Integer.parseInt(client_Id),
					clientAppDbJdbcTemplate);
			dataResponse.setObject(databases);
			if (databases != null && databases.size() > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
	...
	public DataResponse getClientsByDatabaseId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("databaseId") String database_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<Integer> clients = etlAdminService.getClientsByDatabaseId(Integer.parseInt(database_Id),
					clientAppDbJdbcTemplate);
			...
			if (clients != null && clients.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileGettingClients", null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingClients", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveClientDatabaseMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("client_Id") String client_Id, @RequestParam("databaseId") List<String> databaseId,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			int update = 0;
			etlAdminService.deleteClientDatabaseMappingById(Integer.parseInt(client_Id), columnName,
					clientAppDbJdbcTemplate);
			// if(delete > 0){
			update = etlAdminService.saveClientDatabaseMapping(Integer.parseInt(client_Id), databaseId, modification,
					clientAppDbJdbcTemplate);
			...
			if (update > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.clientDatabaseMappingSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.errorWhileSavingClientDatabaseMapping", null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientDatabaseMapping",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveDatabaseClientMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("database_Id") String database_Id, @RequestParam("clientId") List<String> clientIds,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			int update = 0;
			// int delete =
			etlAdminService.deleteClientDatabaseMappingById(Integer.parseInt(database_Id), columnName,
					clientAppDbJdbcTemplate);
			// if(delete > 0){
			update = etlAdminService.saveDatabaseClientMapping(Integer.parseInt(database_Id), clientIds, modification,
					clientAppDbJdbcTemplate);
			// }
			if (update > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.databaseClientMappingSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.errorWhileSavingClientDatabaseMapping", null, locale));
	...
	public DataResponse getDatabaseMappedConnectors(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (databases != null && databases.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileGettingConnectors",
						null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingConnectors", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveClientConnectorMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("client_Id") String client_Id, @RequestParam("connectorId") List<String> connectorIds,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			update = etlAdminService.saveClientConnectorMapping(Integer.parseInt(client_Id), connectorIds, modification,
					clientAppDbJdbcTemplate);
			if (update > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.clientConnectorMappingSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.errorWhileSavingClientConnectorMapping", null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientConnectorMapping",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getConnectorsByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<Database> databases = etlAdminService.getConnectorsByClientId(Integer.parseInt(client_Id),
					clientAppDbJdbcTemplate);
			dataResponse.setObject(databases);
			if (databases != null && databases.size() > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
	...
	public DataResponse getILInfoByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<ILInfo> ilInfo = etlAdminService.getILInfoByClientId(Integer.parseInt(client_Id),
					clientAppDbJdbcTemplate);
			dataResponse.setObject(ilInfo);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingILs", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveclientSpecificIL(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientData clientData, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (insert > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.clientSpecificILInfoSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientSpecificILInfo",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateclientSpecificIL(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientData clientData, HttpServletRequest request, Locale locale) {
	...
	public DataResponse updateclientSpecificIToDefault(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientData clientData, HttpServletRequest request, Locale locale) {
		...
		try {
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while updateclientSpecificILToDefault() ",
			 * e); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientSpecificILInfo",
			 * null, locale)); }
	...
	public DataResponse getDLInfoByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<DLInfo> dlInfo = etlAdminService.getDLInfoByClientId(Integer.parseInt(client_Id),
					clientAppDbJdbcTemplate);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingDLs", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getClientSpecificDLInfoById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("dLId") String dL_Id, @RequestParam("client_id") String client_id, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (dlInfo != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.dLDetailsNotFound", null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveDLInfo", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveclientSpecificDLInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientData clientData, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (insert > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.clientSpecificDLInfoSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientSpecificDLInfo",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateClientSpecificDLInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientData clientData, HttpServletRequest request, Locale locale) {
	...
	public DataResponse updateclientSpecificDLToDefault(
		...
		try {
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while updateclientSpecificDLToDefault() ",
			 * e); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingClientSpecificDLInfo",
	...
	public DataResponse getAllmappingInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") int client_Id, HttpServletRequest request, Locale locale) {
	...
	public DataResponse getCommonJobInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (commonJobInfo != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileGettingCommonJobInfo",
						null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingCommonJobInfo",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveCommonJobInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody CommonJob commonJob, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			...
			if (save > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.commonJobInfoSavedSuccessfully",
						null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileSavingCommonJobInfo",
						null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingCommonJobInfo",
			 * null, locale)); }
			 */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getCommonJobInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("id") int id, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
	...
	public DataResponse updateCommonJobInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody CommonJob commonJob, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (update > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.commonJobInfoUpdatedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileUpdatingCommonJobInfo",
						null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileUpdatingCommonJobInfo",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getAllWebServices(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while getAllWebServices() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveWebservicesList",
			 * null, locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getWebServiceAuthDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody WebService webService, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			allWebservices = etlAdminService.getWebServiceAuthDetailsById(
					Integer.parseInt(webService.getWeb_service_id()), clientAppDbJdbcTemplate);
			if (allWebservices != null) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				messages.add(message);
				dataResponse.setObject(allWebservices);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveWebserviceDetails",
			 * null, locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse saveWsILMappingDetails(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody WebServiceILMapping webServiceILMapping, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		int update = 0, save = 0;
		...
		try {
			...
			if (webServiceILMapping.getWebServiceApis() != null && webServiceILMapping.getWebServiceApis().size() > 0) {
				...
				if (update > 0 || save > 0) {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
					message.setText(messageSource.getMessage(
							"anvizent.message.success.text.webServiceILMappingsSavedSuccessfully", null, locale));
				} else {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
					message.setText(messageSource.getMessage(
							"anvizent.message.error.text.errorWhileSavingWebserviceILMappings", null, locale));
				}
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.errorWhileSavingWebserviceILMappings", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
	...
	public DataResponse getWSILMappingDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("wsTemplateId") int wsTemplateId, @RequestParam("iLId") int iLId, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			if (mappingDetails != null && mappingDetails.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveWsIlmappings",
						null, locale));
			}
		} catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse deleteWSILMappingDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("id") int id, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		int delete = 0;
		...
		try {
			...
			if (delete > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.webServiceILMappingDeletedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.errorWhiledeletingWebserviceILMapping", null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableTodeleteTheWebserviceILMapping",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
		...
		try {
			...
			if (webService.getWeb_service_id() != null) {
				...
				if (wbserviceClients != null) {
					...
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
					message.setText(
							messageSource.getMessage("anvizent.message.error.text.NoClientsMapping", null, locale));
					messages.add(message);
					dataResponse.setMessages(messages);
				}
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveWebServiceClients",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveWebserviceClientMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (webserviceId != null) {
				...
				saveCount = etlAdminService.saveWebserviceClientMapping(webserviceId, checkedClients, eTLAdmin,
						clientAppDbJdbcTemplate);
			}
			if (saveCount > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.webServiceClientMappingSuccessfullyUpdated", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.webServiceClientMappingNotSuccessfullyUpdated", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToCreateWebServiceClientMapping",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getAllWebKPIs(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while getAllKpis() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveKpis", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveDlKpiMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			...
			@RequestParam("checkedKpis") String checkedKpis, @RequestParam("checkedIds") String checkedKpiIds) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		int saveCount = -1;
		...
		try {
			...
			if (saveCount > 0) {
				dataResponse.setObject(saveCount);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.error.text.dlKpiMappingsuccessfullyupdated",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.dlKpiMappingNotsuccessfullyupdated", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse getDefaultQuery(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (defaultQueriesList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.unableToRetrieveDefaultQueriesList", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveDefaultQueriesList",
			 * null, locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getIlincrementalQueryById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			String ilincrQuery = etlAdminService.getIlincrementalQueryById(ilId, databaseTypeId,
					clientAppDbJdbcTemplate);
			if (ilincrQuery != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.unableToRetrieveIncrementalUpdateQuery", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveIncrementalUpdateQuery",
			 * null, locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse gethistoryLoadById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (ilQuery != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveHistoryLoad",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveHistoryLoad", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse geMaxDateQueryById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (ilQuery != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveMaxDateQuery",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveMaxDateQuery", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getNotMappedILs(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (notMappedIlList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.unableToGetNotMappedILs", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveNotMappedILs", null,
			 * locale)); messages.add(message);
			 * dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse saveILDefaultQuery(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToCreateDefaultQuery", null,
						locale));
				messages.add(message);
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToCreateDefaultQuery", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse editILDefaultQuery(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("ilid") Integer ilid, @RequestParam("databaseTypeId") Integer databaseTypeId,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			if (ilQueries != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.defaultQueryDetailsNotFound",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveDefaultQueryDetails",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateILDefaultQuery(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			List<ILConnectionMapping> defaultQueriesList = etlAdminService.getDefaultQuery(
					ilconnectionMapping.getiLConnection().getDatabase().getId(), clientAppDbJdbcTemplate);
			dataResponse.setObject(defaultQueriesList);
			if (ilQueriesUpdate != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.validation.text.unableToUpdateDefaultQuery",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileUpdateDefaultQuery", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getDatabase(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			if (databaseList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveDatabaseList",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveDatabaseList", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getDatabaseById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (databaseConnector != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.databaseDetailsNotFound", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveDatabaseDetails",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getconnector(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveConnectorList",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getConnectorDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("id") Integer id, Locale locale, HttpServletRequest request) {
		...
		try {
			...
			if (connector != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.connectorDetailsNotFound", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveConnectorDetails",
			 * null, locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateConnector(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Database database, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		int connectorUpdate;
		...
		try {
			...
			if (connectorUpdate != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.validation.text.unableToUpdateConnector",
						null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileUpdateConnector", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse createConnector(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Database database, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.unableToCreateConnector", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			message.setText(messageSource.getMessage("anvizent.message.validation.text.ConnectorNameAlreadyExist", null,
					locale));
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileCreatingConnector", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getTableScripts(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (tableScriptsList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unabletoRetrieveTableScripts",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorwhilegetTableScripts", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse addOrUpdateTableScripts(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScripts) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (saveOrUpdateCount > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.tableScriptAddedOrUpdatedSuccessfully", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.tableScriptNotAddedOrUpdatedSuccessfully", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while addOrUpdateTableScripts() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.tableScriptNotAddedOrUpdatedSuccessfully",
			 * null, locale)); messages.add(message); }
			 */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse createDlMaster(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ETLAdmin eTLAdmin, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (eTLAdmin != null) {
				...
				eTLAdmin.setDlId(createdlId);
					...
					if (dlMappingCount > 0) {
						kpiMappingCount = etlAdminService.saveDlKpiMapping(createdlId, "", eTLAdmin,
								clientAppDbJdbcTemplate);
					}
			...
			if (kpiMappingCount > 0) {
				dataResponse.setObject(dlMappingCount);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.dlMastercreatedSuccessfully",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while createDlMaster() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileCreateDlMaster", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateDlMaster(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ETLAdmin eTLAdmin, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (eTLAdmin != null) {
				...
				if (ilMappingCount > 0) {
					...
					kpiMappingCount = etlAdminService.saveDlKpiMapping(eTLAdmin.getDlInfo().getdL_id(), "", eTLAdmin,
							clientAppDbJdbcTemplate);
				}
				if(eTLAdmin.getDlInfo().getJobExecutionType().equals("T")){
					if (kpiMappingCount > 0) {
						etlAdminService.deleteDLContextParams(eTLAdmin.getDlInfo().getdL_id(), clientAppDbJdbcTemplate);
						contextparamMappingCount = etlAdminService.saveEtlDlContextParams(eTLAdmin,
								clientAppDbJdbcTemplate);
					}	
				}
			...
			if (kpiMappingCount > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.dlMasterCreationOrUpdationSuccessfully", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.dlMasterCreationOrUpdationFailed",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while updateDlMaster() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileUpdateDlMaster", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getTableScriptsByClient(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			tableScriptsList = etlAdminService.getTableScriptsByClient(tableScripts.getClientId(),
					clientAppDbJdbcTemplate);
			...
			if (tableScriptsList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.dataNotFoundForTheClient", null, locale)
								+ tableScripts.getClientId());
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGetTableScriptsByClient",
			 * null, locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse addTableScriptsMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScripts) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (saveCount > 0) {
				dataResponse.setObject(saveCount);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.tableScriptAddedSuccessfully",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.tableScriptNotAddedSuccessfully",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileAddTableScriptsMapping",
			 * null, locale)); messages.add(message); }
			 */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getTableScriptsMappingById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScripts) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (tableScripts != null) {
				...
				if (executedCount > 0) {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
					message.setText(messageSource.getMessage(
							"anvizent.message.error.text.thiscriptisalreadyexecutedPleaseaddnewscript", null, locale));
					messages.add(message);
					dataResponse.setMessages(messages);
					return dataResponse;
				}
			...
			if (tableScript != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.tableScriptNotFound", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getTableScriptsMappingById() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileAddTableScriptsMapping",
	...
	public DataResponse getTableScriptViewById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScripts) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse updateTableScriptsMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScripts) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (tableScripts != null) {
				...
				if (mappedCount > 0) {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
					message.setText(messageSource.getMessage("anvizent.message.error.text.thisScriptIsAlreadyMappedRemoveMappingsToEdit",
							new Object[] { mappedCount }, locale));	
			...
			if (saveCount > 0) {
				dataResponse.setObject(saveCount);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.tableScriptUpdatedSuccessfully",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.tableScriptNotUpdatedSuccessfully", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while updateTableScriptsMapping() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileUpdateTableScriptsMapping",
			 * null, locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateDatabase(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Database database, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (databaseUpdate != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.validation.text.unableToUpdateDatabase",
						null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			message.setText(messageSource.getMessage("anvizent.message.validation.text.databaseNameAlreadyExist", null,
					locale));
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileUpdateDatabase", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse createDB(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Database database, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.unableToCreateDatabase", null, locale));
			}
		} catch (AnvizentDuplicateFileNameException ae) {
			// packageService.logError(ae, request);
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileCreateDatabase", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getDatabaseTypes(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		...
		try {
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getDatabaseTypes() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.fail.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileGettingDatabases", null,
	...
	public DataResponse saveClientTableScriptsMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScripts) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (tableScripts != null) {
				...
				modification.setCreatedBy(clientId + "\n" + request.getHeader("Browser-Detail"));
				tableScripts.setModification(modification);
				delete = etlAdminService.deleteClientTableScriptsMapping(tableScripts.getClientId(),
						clientAppDbJdbcTemplate, commonJdbcTemplate);
				saveCount = etlAdminService.saveClientTableScriptsMapping(tableScripts, clientAppDbJdbcTemplate,
						commonJdbcTemplate);
			}
			if (saveCount > 0 || (delete > 0 && saveCount == 0)) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.noTableScriptWasSelected", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while saveClientTableScriptsMapping() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileAddTableScriptsMapping",
	...
	public DataResponse getTableScriptsMappingByClient(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, @RequestBody TableScriptsForm tableScripts, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			tableScriptsList = etlAdminService.getTableScriptsMappingByClient(tableScripts.getClientId(),
					clientAppDbJdbcTemplate);
			...
			if (tableScriptsList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.tableScriptsExecutedSuccessfully", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.tableScriptsNotExecutedSuccessfully", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse clientTableScriptsExecution(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			Locale locale, HttpServletRequest request, @RequestBody TableScriptsForm tableScriptsForm) {
		...
		try {
			...
			if (tableScriptsForm != null) {
				...
				if (scriptIds.size() > 0) {
					...
					tableScriptLists = etlAdminService.getSqlScriptByScriptIds(tableScriptsForm.getClientId(),
							scriptIds, commonJdbcTemplate);
					...
					for (TableScripts tableScript : tableScriptLists) {
						try {
							...
							if (con != null) {
								...
								etlAdminService.updateTableScriptsMappingIsExecuted(tableScriptsForm.getClientId(),
										tableScript.getId(), true, modification, clientAppDbJdbcTemplate,
										commonJdbcTemplate);
								etlAdminService.updateTableScriptsMappingIsError(tableScriptsForm.getClientId(),
										tableScript.getId(), false, modification, clientAppDbJdbcTemplate,
										commonJdbcTemplate);
								count++;
							}
							...
							etlAdminService.updateTableScriptsMappingIsNotExecutedErrorMsg(
									tableScriptsForm.getClientId(), tableScript.getId(), e.getMessage(), modification,
									commonJdbcTemplate);
							etlAdminService.updateTableScriptsMappingIsError(tableScriptsForm.getClientId(),
									tableScript.getId(), true, modification, clientAppDbJdbcTemplate,
									commonJdbcTemplate);
					...
					if (count > 0) {
						...
						message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
						message.setText(messageSource.getMessage(
								"anvizent.message.error.text.tableScriptsNotExecutedSuccessfully", null, locale));
						messages.add(message);
						dataResponse.setMessages(messages);
					}
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error while clientTableScriptsExecution() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, null));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.executionFailed", null, locale));
			 * messages.add(message); dataResponse.setMessages(messages); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		} finally {
	...
	public DataResponse getWebserviceByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("client_Id") String client_Id, HttpServletRequest request, Locale locale) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<WebService> webservices = etlAdminService.getWebserviceByClientId(Integer.parseInt(client_Id),
					clientAppDbJdbcTemplate);
			...
			if (webservices != null && webservices.size() > 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.errorWhilegetWebserviceByClientId", null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhilegetWebserviceByClientId",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveClientWebserviceMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("client_Id") int client_Id, @RequestParam("webServiceIds") List<Integer> webServiceIds,
			HttpServletRequest request, Locale locale) {
		...
		try {
			...
			update = etlAdminService.saveClientWebserviceMapping(client_Id, webServiceIds, modification,
					clientAppDbJdbcTemplate);
			if (update > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.clientWebserviceMappingSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
	...
	public DataResponse getTableScriptsMappingIsNotExecutedErrorMsg(
			...
			@RequestBody TableScriptsForm tableScriptsForm, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			errorMsg = etlAdminService.getTableScriptsMappingIsNotExecutedErrorMsg(tableScriptsForm.getClientId(),
					tableScriptsForm.getId(), clientAppDbJdbcTemplate);
			if (errorMsg != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorFoundWhileGettingErrorMsgs",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error(
			 * "error while getTableScriptsMappingIsNotExecutedErrorMsg() ",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorwhilegetTableScripts", null,
	...
	public DataResponse updateConnectorsAsDefault(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			...
			@RequestParam("mappingType") String mappingType, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			int create = etlAdminService.saveDefaultTemplateMasterMappingData(templateId, mappingType, masterIds,
					modification, clientAppDbJdbcTemplate);
			if (create != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				if (mappingType.equals("vertical"))
					messageText = messageSource.getMessage(
							"anvizent.message.success.text.defaultVerticalsSavedSuccessfully", null, locale);
				else if (mappingType.equals("connector"))
					messageText = messageSource.getMessage(
							"anvizent.message.success.text.defaultConnectorsSavedSuccessfully", null, locale);
				else if (mappingType.equals("dl"))
					messageText = messageSource.getMessage("anvizent.message.success.text.defaultDLsSavedSuccessfully",
							null, locale);
				else if (mappingType.equals("tablescript"))
					messageText = messageSource.getMessage(
							"anvizent.message.success.text.defaultTablescriptsSavedSuccessfully", null, locale);
				else if (mappingType.equals("webservice"))
					messageText = messageSource.getMessage(
							"anvizent.message.success.text.defaultWebServicesSavedSuccessfully", null, locale);
				else
					messageText = messageSource.getMessage("anvizent.message.success.text.s3BucketSavedSuccessfully",
							null, locale);
				...
				if (mappingType.equals("vertical"))
					messageText = messageSource
							.getMessage("anvizent.message.error.text.errorWhileSavingDefaultVerticals", null, locale);
				else if (mappingType.equals("connector"))
					messageText = messageSource
							.getMessage("anvizent.message.error.text.errorWhileSavingDefaultConnector", null, locale);
				else if (mappingType.equals("dl"))
					messageText = messageSource.getMessage("anvizent.message.error.text.errorWhileSavingDefaultDls",
							null, locale);
				else if (mappingType.equals("tablescript"))
					messageText = messageSource.getMessage(
							"anvizent.message.error.text.errorWhileSavingDefaultTablescripts", null, locale);
				else if (mappingType.equals("webservice"))
					messageText = messageSource
							.getMessage("anvizent.message.error.text.errorWhileSavingDefaultWebServices", null, locale);
				else
					messageText = messageSource.getMessage("anvizent.message.error.text.unableToSaveDetails", null,
							locale);
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error(
			 * "error while saveDefaultTemplateMasterMappingData() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.fail.code", null, locale)); if
			 * (mappingType.equals("vertical")) messageText =
			 * messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingDefaultVerticals",
			 * null, locale); else if (mappingType.equals("connector"))
			 * messageText = messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingDefaultConnector",
			 * null, locale); else if (mappingType.equals("dl")) messageText =
			 * messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingDefaultDls", null,
			 * locale); else if (mappingType.equals("tablescript")) messageText
			 * = messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingDefaultTablescripts",
			 * null, locale); else messageText = messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingDefaultWebServices",
			 * null, locale); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getInstantTableScriptsIsNotExecutedErrorMsg(
		...
		try {
			...
			errorMsg = etlAdminService.getInstantTableScriptsIsNotExecutedErrorMsg(tableScriptsForm.getId(),
					tableScriptsForm.getClientId(), clientAppDbJdbcTemplate);
			if (errorMsg != null) {
				dataResponse.setObject(errorMsg);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				messages.add(message);
	...
	public DataResponse getPreviousTableScriptView(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			tableScript = etlAdminService.getPreviousTableScriptView(tableScripts.getId(), tableScripts.getClientId(),
					clientAppDbJdbcTemplate);
			if (tableScript != null) {
				dataResponse.setObject(tableScript);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
	...
	public DataResponse getAllDefaultTemplatesInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
	...
	public DataResponse createDefaultTemplate(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody DefaultTemplates defaultTemplates, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			...
			if (newTemplateId != -1) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.defaultTemplateCreatedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.defaultTemplatesNotFound", null, locale));
			...
			message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
			message.setText(
					messageSource.getMessage("anvizent.message.error.text.defaultTemplateAlreadyExits", null, locale));
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getAllDefaultTemplatesInfo() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorwhileCreatingDefaultTemplate",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateDefaultTemplate(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody DefaultTemplates defaultTemplates, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (templateId != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.defaultTemplateupdatedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.defaultTemplatesNotFound", null, locale));
	...
	public DataResponse getDefaultTemplateMasterMappedData(
		...
		try {
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getDefaultTemplateMasterMappedData() ",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorwhileCreatingDefaultTemplate",
	...
	public DataResponse getDefaultTemplateInfoById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("templateId") int templateId, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			DefaultTemplates defaultTemplate = etlAdminService.getDefaultTemplateInfoById(templateId,
					clientAppDbJdbcTemplate);
			if (defaultTemplate != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.errorwhileGettingDefaultTemplateInformation", null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
	...
	public DataResponse getAllServerConfigurations(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			List<ServerConfigurations> serverConfigList = etlAdminService
					.getAllServerConfigurations(clientAppDbJdbcTemplate);
			if (serverConfigList != null && serverConfigList.size() > 0) {
				dataResponse.setObject(serverConfigList);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.serverConfigurationDetailsNotFound",
						null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 ...
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale)); message.setText(
			 * "Unable to retrive server configuration details."); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveServerConfigurationDetails(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ServerConfigurations serverConfigurations, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			...
			int save = etlAdminService.saveServerConfigurationDetails(serverConfigurations, modification,
					clientAppDbJdbcTemplate);
			if (save > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.serverConfigSavedSuccessfully",
						null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileSavingServerConfig",
						null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while saveServerConfigurationDetails() ",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale)); message.setText(
			 * "Error while saving server configuration details."); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateServerConfigurationDetails(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ServerConfigurations serverConfigurations, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		...
		try {
			...
			int save = etlAdminService.updateServerConfigurationDetails(serverConfigurations, modification,
					clientAppDbJdbcTemplate);
			if (save > 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.serverConfigUpdatedSuccessfully",
						null, locale));	
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.errorWhileUpdatingServerConfig",
						null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while updateServerConfigurationDetails() ",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale)); message.setText(
			 * "Error while updating server configuration details."); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateServerConfigurationDetails(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @PathVariable("id") int id, Locale locale,
			HttpServletRequest request) {
		...
		try {
			...
			if (sc != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveServerConfigdetails",
						null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getServerConfigurationDetailsById() ",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale)); message.setText(
			 * "Unable to retrive server configuration details."); }
			 */ catch (Throwable t) {
	...
	public DataResponse getILsByWSMappingId(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestParam("wsTemplateId") int wsTemplateId, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveIlInfo", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getAvailableJarsList(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getAvailableJarsList() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveJarFiles", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse saveGeneralSettings(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody GeneralSettings generalSettings, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.settingsSavedSuccessfully",
						null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileSavingSettings", null, locale));
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorWhileSavingSettings", null,
			 * locale)); }
			 */catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getSettingsInfoByID(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, @PathVariable("client_id") int client_id, Locale locale) {
		...
		try {
			...
			if (settingsInfo != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unabletoRetrieveWebServiceList",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorwhileGettingSettingsInfo",
			 * null, locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse updateGeneralSettings(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody GeneralSettings generalSettings, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (updateInfo != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource
						.getMessage("anvizent.message.success.text.generalSettingsUpdatedSuccessfully", null, locale));
			} else {
				int save = etlAdminService.saveGeneralSettings(generalSettings, clientAppDbJdbcTemplate);
				if (save != 0) {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
					message.setText(messageSource.getMessage(
							"anvizent.message.success.text.generalSettingsUpdatedSuccessfully", null, locale));
				} else {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
					message.setText(
							messageSource.getMessage("anvizent.message.error.text.updationFailed", null, locale));
				}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while updateGeneralSettings() ", ae);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.errorwhileUpdatingSettings", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public ResponseEntity<byte[]> downloadJar(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, HttpServletResponse response, @PathVariable("jarName") String jarName,
			Locale locale) {
	...
	public DataResponse saveclientConfigSettings(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientConfigurationSettings clientConfigurationSettings, Locale locale,
			HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.configurationSettingsSavedSuccessfully", null, locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(
						messageSource.getMessage("anvizent.message.error.text.errorWhileSavingSettings", null, locale));
	...
	public DataResponse getConfigSettingsInfoByID(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, @PathVariable("client_id") int client_id, Locale locale) {
		...
		try {
			...
			if (settingsInfo != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unabletoRetrieveClientConfigInfo",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse updateclientConfigSettings(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientConfigurationSettings clientConfigurationSettings, Locale locale,
			HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		...
		try {
			...
			modification.setModifiedDateTime(new Date());
			clientConfigurationSettings.setModification(modification);
			int updateInfo = etlAdminService.updateclientConfigSettings(clientConfigurationSettings,
					clientAppDbJdbcTemplate);
			if (updateInfo != 0) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage(
						"anvizent.message.success.text.configurationSettingsUpdatedSuccessfully", null, locale));
			} else {
				int save = etlAdminService.saveclientConfigSettings(clientConfigurationSettings,
						clientAppDbJdbcTemplate);
				if (save != 0) {
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
					message.setText(messageSource.getMessage(
	...
	public DataResponse migrateUserToUser(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale, @PathVariable("packageIds") String packageIds,
		...
		try {
			...
			String packageQuery = "select * from package where package_id in(" + packageIds + ") and user_id ="
					+ clientUserId;
			...
			if (tableData != null && !tableData.isEmpty()) {
				...
				for (Map<String, Object> data : tableData) {
					...
					for (Map.Entry<String, Object> entry : data.entrySet()) {
						...
						if (key.equals("package_id")) {
							...
							List<Map<String, Object>> ilConnectiontableData = packageService
									.getTableData(ilConnectionQuery, "", null);
									...
									for (Map.Entry<String, Object> ilConnectionEntry : map.entrySet()) {
										...
										if (ilConnectionKey.equals("isWebService")) {
											...
											if (ilConnectionValue.toString().equalsIgnoreCase("true")) {
												...
												String wsmappingQry = "SELECT * FROM  il_connection_web_service_mapping where il_connection_mapping_id ="
														+ ilConnectionMappingId + "";

												List<Map<String, Object>> wsmappingData = packageService
														.getTableData(wsmappingQry, "", null);

												if (wsmappingData != null && !wsmappingData.isEmpty()) {

													ilConJsonObject.put("IlConnectionWsMapping",
															getJsonArray(wsmappingData));
												}
											}
										}
										...
										if (data.get("isStandard").toString().equalsIgnoreCase("false")) {
											...
											if (map.get("isFlatFile").toString().equalsIgnoreCase("true")) {
												...
												String fileHeaderInfoQry = "SELECT * FROM  file_headers_info where file_path =  '"
														+ map.get("filePath") + "'";

												List<Map<String, Object>> fileHeaderInfoTableData = packageService
														.getTableData(fileHeaderInfoQry, "", null);

												if (fileHeaderInfoTableData != null
														&& !fileHeaderInfoTableData.isEmpty()) {

													ilConJsonObject.put("FileHeadersInfo",
															getJsonArray(fileHeaderInfoTableData));
												}
											}
							...
							if (data.get("isStandard").toString().equalsIgnoreCase("false")) {
								...
								String customPackageTargetTableInfoQry = "SELECT * FROM  custom_package_target_table_info where package_Id ="
										+ value + "";

								List<Map<String, Object>> cpTargetTableInfoTableData = packageService
										.getTableData(customPackageTargetTableInfoQry, "", null);

								if (cpTargetTableInfoTableData != null && !cpTargetTableInfoTableData.isEmpty()) {

									jsonObject.put("CustomPackageTargetTableInfo",
											getJsonArray(cpTargetTableInfoTableData));
								}

								String cpTargetTblQry = "SELECT * FROM  custom_package_target_table_query where packageId ="
										+ value + "";

								List<Map<String, Object>> cpTargetTblQryTableData = packageService
										.getTableData(cpTargetTblQry, "", null);

								if (cpTargetTblQryTableData != null && !cpTargetTblQryTableData.isEmpty()) {

									jsonObject.put("CustomPackageTargetTableQuery",
											getJsonArray(cpTargetTblQryTableData));
								}

								String cpTargetTblDerivativesQry = "SELECT * FROM  custom_package_target_table_derivatives where package_Id ="
										+ value + "";

								List<Map<String, Object>> cpTargetTblDerivativesTableData = packageService
										.getTableData(cpTargetTblDerivativesQry, "", null);

								if (cpTargetTblDerivativesTableData != null
										&& !cpTargetTblDerivativesTableData.isEmpty()) {

									jsonObject.put("CustomPackageTargetTableDerivatives",
											getJsonArray(cpTargetTblDerivativesTableData));
								}

								String cpFileTempTablesMappingQry = "SELECT * FROM  file_temp_tables_mapping where packageId ="
										+ value + "";

								List<Map<String, Object>> cpFileTempTablesMappingTableData = packageService
										.getTableData(cpFileTempTablesMappingQry, "", null);

								if (cpFileTempTablesMappingTableData != null
										&& !cpFileTempTablesMappingTableData.isEmpty()) {

									jsonObject.put("CustomPackageFileTempTablesMapping",
											getJsonArray(cpFileTempTablesMappingTableData));
								}
				...
				if (finalJsonObject.keySet().size() > 0) {
					...
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
					message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrievePackageTablesData",
							null, locale));
					messages.add(message);
					dataResponse.setMessages(messages);
				}
				 ...
				 * 
				 * file.write(finalJsonObject.toJSONString()); file.flush();
				 * 
			 ...
			 * catch (Exception e) { packageService.logError(e, request);
			 * LOGGER.error("error migrateUserToUser() ", e);
			 * message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToRetrieveKpisDetails", null,
	...
	public DataResponse getUsersByClientId(@PathVariable(Constants.PathVariables.CLIENT_ID) String userId,
			HttpServletRequest request, @PathVariable("client_Id") String clientId, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (usersList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToRetrieveUsers",
						null, locale));
			}
		} /*
			 * catch (Exception e) { packageService.logError(e, request);
	...
	public DataResponse getUserPackageList(@PathVariable(Constants.PathVariables.CLIENT_ID) String userId,
			HttpServletRequest request, @PathVariable("clientUserId") String clientUserId, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse saveCurrencyIntegration(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody CurrencyIntegration currencyIntegration, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		...
		try {
			...
			if (save != 0) {
				dataResponse.setObject(save);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.currencyIntegrationSave", null,
						locale));
			} else {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.currencyIntegrationSaveError",
						null, locale));
			}
	...
	public DataResponse getCurrencyIntegration(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			CurrencyIntegration currencyIntegrationList = etlAdminService
					.getCurrencyIntegration(clientAppDbJdbcTemplate);
			...
			if (currencyIntegrationList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource
						.getMessage("anvizent.message.error.text.unabletoRetrieveServerClientDetails", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse getInstantRunInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, @RequestBody CurrencyIntegration currencyIntegration, Locale locale
	...
	public DataResponse getJobResultsForHistoricalLoad(@PathVariable(Constants.PathVariables.CLIENT_ID) String userId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getAllClientsByServer(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("serverId") int serverId, Locale locale, HttpServletRequest request) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			ServerConfigurations serverConfigurations = etlAdminService.getServerConfigurationDetailsById(serverId,
					clientAppDbJdbcTemplate);
			...
			if (serverConfigurations != null) {
				...
				if (clientList != null) {
					...
					message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
					message.setText(messageSource.getMessage(
							"anvizent.message.error.text.unabletoRetrieveServerClientDetails", null, locale));
					messages.add(message);
					dataResponse.setMessages(messages);
				}
			}
	...
	public DataResponse getDependencyDetailsForSourceServerClient(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody TemplateMigration templateMigration, Locale locale, HttpServletRequest request) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			ServerConfigurations sourceServerConfigurations = etlAdminService.getServerConfigurationDetailsById(
					Integer.parseInt(templateMigration.getServerId()), clientAppDbJdbcTemplate);
			ServerConfigurations destinationServerConfigurations = etlAdminService.getServerConfigurationDetailsById(
					Integer.parseInt(templateMigration.getDestinationServerId()), clientAppDbJdbcTemplate);
			...
			if (sourceServerConfigurations != null) {
				...
				packageList = etlAdminService.getPackageList(sourceJdbcTemplate, templateMigration.getClientId(),
						clientAppDbJdbcTemplate);
				usersList = etlAdminService.getUsersList(sourceJdbcTemplate, templateMigration.getClientId(),
						clientAppDbJdbcTemplate);
				dbConnectionList = etlAdminService.getDatabaseConnectionList(sourceJdbcTemplate,
						templateMigration.getClientId(), clientAppDbJdbcTemplate);
				wsConnectionList = etlAdminService.getWsConnectionList(sourceJdbcTemplate,
						templateMigration.getClientId(), clientAppDbJdbcTemplate);
				clientSpecificILJarsList = etlAdminService.getClientSpecificILJarsList(sourceJdbcTemplate,
						templateMigration.getClientId(), clientAppDbJdbcTemplate);
				clientSpecificDLJarsList = etlAdminService.getClientSpecificDLJarsList(sourceJdbcTemplate,
						templateMigration.getClientId(), clientAppDbJdbcTemplate);
				templatesList = etlAdminService.getTemplatesList(sourceJdbcTemplate, templateMigration.getClientId(),
						clientAppDbJdbcTemplate);
				tableScriptsList = etlAdminService.getTableScriptsList(sourceJdbcTemplate,
						templateMigration.getClientId(), clientAppDbJdbcTemplate);

				ILConnection destinationIlConnection = CommonUtils
						.getDestinationIlConnection(destinationServerConfigurations);
				JdbcTemplate destinationJdbcTemplate = CommonUtils.getClientJdbcTemplate(destinationIlConnection);

				destinationPackageList = etlAdminService.getPackageList(destinationJdbcTemplate,
						templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				detinationUsersList = etlAdminService.getUsersList(destinationJdbcTemplate,
						templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				destinationDbConnectionList = etlAdminService.getDatabaseConnectionList(destinationJdbcTemplate,
						templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				destinationWsConnectionList = etlAdminService.getWsConnectionList(destinationJdbcTemplate,
						templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				destinationClientSpecificILJarsList = etlAdminService.getClientSpecificILJarsList(
						destinationJdbcTemplate, templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				destinationClientSpecificDLJarsList = etlAdminService.getClientSpecificDLJarsList(
						destinationJdbcTemplate, templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				destinationTemplatesList = etlAdminService.getTemplatesList(destinationJdbcTemplate,
						templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
				destinationTableScriptsList = etlAdminService.getTableScriptsList(destinationJdbcTemplate,
						templateMigration.getDestinationClientId(), clientAppDbJdbcTemplate);
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getDependencyDetailsForPackages()",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
	...
	public DataResponse migrateUserFromSourceToDestination(
		...
		try {
			...
			if (sourceServerConfigurations != null && destinationServerConfigurations != null) {
				...
				ILConnection destinationIlConnection = CommonUtils
						.getSourceIlConnection(destinationServerConfigurations);
				JdbcTemplate destinationJdbcTemplate = CommonUtils.getClientJdbcTemplate(destinationIlConnection);
				...
				try {
					...
					selectStatement = sourceConnection.prepareStatement(
							"select * from user where userId in(" + templateMigration.getSourceUserIds() + ")");

					resultSet = selectStatement.executeQuery();

					insertStatement = destinationConnection
							.prepareStatement(CommonUtils.createInsertSql(resultSet.getMetaData(), "user"));
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
				message.setText(messageSource.getMessage("anvizent.message.success.text.successfullyMigrated",
						null, locale));	
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while migrateUserFromSourceToDestination()",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			...
			if (sourceServerConfigurations != null && destinationServerConfigurations != null) {
				...
				try {
					...
					for (int i = 0; i < userArray.length; i++) {
						...
						destinationConnection = destinationJdbcTemplate.getDataSource().getConnection();
						// Il Connections
						ilConSelectStatement = sourceConnection
								.prepareStatement("select * from il_connection where connection_id in("
										+ templateMigration.getSourceDbConIds() + ")");
						ilConSelectResultSet = ilConSelectStatement.executeQuery();
						while (ilConSelectResultSet != null && ilConSelectResultSet.next()) {
							ilConnectionMap = CommonUtils.getIlConnectionMap(ilConSelectResultSet, templateMigration,
									destinationConnection, false);
						}
					}
				} finally {
	...
	public DataResponse migrateWsConFromSourceToDestination(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody TemplateMigration templateMigration, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
			...
			if (sourceServerConfigurations != null && destinationServerConfigurations != null) {
				...
				try {
					...
					for (int i = 0; i < userArray.length; i++) {
						...
						destinationConnection = destinationJdbcTemplate.getDataSource().getConnection();
						// ws Connections
						wsConSelectStatement = sourceConnection
								.prepareStatement("select * from ws_connections_mst where id in ("
										+ templateMigration.getSourceWsConIds() + ")");
						wsConSelectResultSet = wsConSelectStatement.executeQuery();

						while (wsConSelectResultSet != null && wsConSelectResultSet.next()) {
							wsConnectionMap = CommonUtils.getWsConnectionMap(wsConSelectResultSet, templateMigration,
									destinationConnection, false);
						}
					}
				} finally {
	...
	public DataResponse getVersionUpgrade(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse createVersionUpgrade(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody VersionUpgrade versionUpgrade, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		// userObjectRemoved
		...
		try {
			...
			int save = 0;
			VersionUpgrade versionUpgrade1 = etlAdminService.getVersionUpgradeDetailsByVersionNumber(
					versionUpgrade.getVersionNumber(), clientAppDbJdbcTemplate);

			if (versionUpgrade1 != null && versionUpgrade.getVersionId() != versionUpgrade1.getVersionId()) {
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.validation.text.versionNumberAlreadyExists",
						null, locale));	
				return dataResponse;
			}
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToCreateVersionUpgrade",
						null, locale));
			}
		} /*
			 * catch (Exception ae) { packageService.logError(ae, request);
	...
	public DataResponse getVersionUpgradeDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("id") int id, Locale locale, HttpServletRequest request) {
		...
		try {
			...
			if (verUpgrade != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.versionUpgradeDetailsNotFound",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse getClientCurrencyMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (clientCurrencyMapping1 != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.unabletoRetrieveClientCurrenctMappingDetails", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse createClientCurrencyMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientCurrencyMapping clientCurrencyMapping, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		// userObjectRemoved
	...
	public DataResponse getclientCurrencyMappingDetailsById(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @PathVariable("id") int id, Locale locale,
			HttpServletRequest request) {
		...
		try {
			...
			if (clientCurrencyMapInfo != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage(
						"anvizent.message.error.text.unabletoGetClientCurrenctMappingDetails", null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
		} /*
	...
	public DataResponse getclientCurrencyMappingDetailsByClientId(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @PathVariable("CLIENT_ID") int id,
			Locale locale, HttpServletRequest request) {
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			clientCurrencyMapInfo = etlAdminService.getclientCurrencyMappingDetailsByClientId(id,
					clientAppDbJdbcTemplate);
			if (clientCurrencyMapInfo != null) {
				dataResponse.setObject(clientCurrencyMapInfo);
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.SUCCESS);
	...
	public DataResponse createCurrencyMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientCurrencyMapping clientCurrencyMapping, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
		try {
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unableToSaveDetails", null,
			 * locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getDefaultCurrencyInfoById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@PathVariable("templateId") int templateId, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			ClientJdbcInstance clientJdbcInstance = userService.getClientJdbcInstance(clientIdfromHeader);
			clientAppDbJdbcTemplate = clientJdbcInstance.getClientAppdbJdbcTemplate();
			ClientCurrencyMapping currencyMap = etlAdminService.getDefaultCurrencyInfoById(templateId,
					clientAppDbJdbcTemplate);
			if (currencyMap != null) {
	...
	public DataResponse getCurrencyList(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (currencyList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unabletoRetrieveCurrencyList",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unabletoRetrieveCurrencyList", null,
			 * locale)); messages.add(message); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse savePropertiesKeyValuePairs(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody Internalization internalization, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
	...
	public DataResponse getPropertiesList(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getpropertiesKeyValuePairsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
		...
		try {
			...
			if (propertiesInfo != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unabletoRetrievePropertiesList",
						null, locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
			 ...
			 * catch (Exception ae) { packageService.logError(ae, request);
			 * LOGGER.error("error while getpropertiesKeyValuePairsById() ",
			 * ae); message.setCode(messageSource.getMessage(
			 * "anvizent.message.error.code", null, locale));
			 * message.setText(messageSource.getMessage(
			 * "anvizent.message.error.text.unabletoRetrievePropertiesList",
			 * null, locale)); }
			 */ catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
		}
	...
	public DataResponse getS3InfoList(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		...
		try {
			...
			if (s3InfoList != null) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.FAILED);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unabletoRetrieveS3infoList", null,
						locale));
				messages.add(message);
				dataResponse.setMessages(messages);
			}
	...
	public DataResponse saveS3BucketInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody S3BucketInfo s3BucketInfo, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		JdbcTemplate clientAppDbJdbcTemplate = null;
	...
	public DataResponse getBucketList(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse saveClientMapping(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody S3BucketInfo s3BucketInfo, Locale locale, HttpServletRequest request) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse createMiddleLevelManager(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody MiddleLevelManager middleLevelManager, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		messages.add(message);
		...
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToMiddleLevelManagerInfo",
						null, locale));
			}
		} catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getMiddleLevelManagerDetailsById(
	...
	public DataResponse saveHybridClientsGroupingInfo(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody HybridClientsGrouping hybridClientsGrouping, HttpServletRequest request,
			Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getHybridClientGroupingDetailsById(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,@PathVariable("id") long id, Locale locale,
			HttpServletRequest request) {
	...
	public DataResponse createClientJobExecutionParams(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			@RequestBody ClientJobExecutionParameters clientJobExecutionParameters, HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
		messages.add(message);
		...
		try {
			...
			if (save != 0) {
				...
				message.setCode(com.anvizent.client.data.to.csv.path.converter.constants.Constants.Config.ERROR);
				message.setText(messageSource.getMessage("anvizent.message.error.text.unableToJobExecutionParamterDetails",
						null, locale));
			}
		} catch (Throwable t) {
			MinidwServiceUtil.getErrorMessage(message, "ERROR", t);
	...
	public DataResponse getclientJobExecutionParametersDetailsById(
			@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, Locale locale,
			HttpServletRequest request) {
	...
	public DataResponse getMasterVerticals(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request,@RequestParam("verticalIds") List<Integer> verticalIds, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		List<Industry> industries = new ArrayList<>();
	...
	public DataResponse saveNotMappedVerticals(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody Industry industry,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getMasterDatabases(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request,@RequestParam("databaseIds") List<Integer> databaseIds, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
	...
	public DataResponse saveNotMappedDatabases(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody Database database,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse getMasterConnectors(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId,
			HttpServletRequest request,@RequestParam("connectorsIds") List<Integer> connectorsIds, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		Message message = new Message();
		List<Message> messages = new ArrayList<>();
		List<Database> databases = new ArrayList<>();
	...
	public DataResponse saveNotMappedConnectors(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody Database database,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
	...
	public DataResponse executeInsertScripts(@PathVariable(Constants.PathVariables.CLIENT_ID) String clientId, @RequestBody MultiClientInsertScriptsExecution multiClientInsertScriptsExecution,
			HttpServletRequest request, Locale locale) {
		DataResponse dataResponse = new DataResponse();
		List<Message> messages = new ArrayList<>();
		Message message = new Message();
