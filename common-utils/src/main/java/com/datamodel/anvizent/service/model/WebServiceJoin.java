...
public String toString() {
	return "WebServiceJoin [webServiceUrl=" + webServiceUrl + ", webServiceMethodType=" + webServiceMethodType
			+ ", responseObjectName=" + responseObjectName + ", webServiceApiName=" + webServiceApiName
			+ ", apiPathParams=" + apiPathParams + ", apiRequestParams=" + apiRequestParams + ", apiBodyParams="
			+ apiBodyParams + ", paginationRequired=" + paginationRequired + ", paginationRequestParamsData="
			+ paginationRequestParamsData + ", incrementalUpdate=" + incrementalUpdate + ", incrementalUpdateparamdata="
			+ incrementalUpdateparamdata + ", responseColumnObjectName=" + responseColumnObjectName
			+ ", validateOrPreview=" + validateOrPreview + ", wsMappingId=" + wsMappingId + ", baseUrl=" + baseUrl
			+ ", baseUrlRequired=" + baseUrlRequired + ", paginationType=" + paginationType + ", soapBodyElement="
			+ soapBodyElement + "]";
}
