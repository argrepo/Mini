...
public class WebService {
	...
	public String toString() {
		return "WebService [wsConId=" + wsConId + ", url=" + url + ", paramKey=" + paramKey + ", paramValue="
				+ paramValue + ", requestMethod=" + requestMethod + ", headers=" + headers + ", requestParameters="
				+ requestParameters + ", authenticationUrl=" + authenticationUrl + ", authenticationRequired="
				+ authenticationRequired + ", cookieRequired=" + cookieRequired + ", apiName=" + apiName + ", ilId="
				+ ilId + ", industryId=" + industryId + ", packageId=" + packageId + ", pathParams=" + pathParams
				+ ", requestBodyParams=" + requestBodyParams + ", email=" + email + ", password=" + password
				+ ", authRequsetParams=" + authRequsetParams + ", responseObjName=" + responseObjName + ", tokenName="
				+ tokenName + ", authentication_Request_Params=" + authentication_Request_Params
				+ ", Web_Service_Path_Params=" + Web_Service_Path_Params + ", web_service_id=" + web_service_id
				+ ", authentication_Method_Type=" + authentication_Method_Type + ", web_Service_Method_Type="
				+ web_Service_Method_Type + ", webserviceName=" + webserviceName + ", web_service_sub_url="
				+ web_service_sub_url + ", web_service_sub_url_param=" + web_service_sub_url_param
				+ ", responseColumnObjName=" + responseColumnObjName + ", Web_Service_Request_Body_Params="
				+ Web_Service_Request_Body_Params + ", requsetBodyParamKey=" + requsetBodyParamKey
				+ ", requsetBodyParamKeyParamValue=" + requsetBodyParamKeyParamValue + ", clientId=" + clientId
				+ ", isChangeAuthDetails=" + isChangeAuthDetails + ", modification=" + modification + ", oauth2="
				+ oauth2 + ", userId=" + userId + ", authCode=" + authCode + ", userTokenName=" + userTokenName
				+ ", webServiceJoin=" + webServiceJoin + ", authenticationTypeId=" + authenticationTypeId
				+ ", headerKeyValues=" + headerKeyValues + ", apiPathParams=" + apiPathParams + ", apiBodyParams="
				+ apiBodyParams + ", incrementalUpdate=" + incrementalUpdate + ", incrementalUpdateparamdata="
				+ incrementalUpdateparamdata + ", paginationRequired=" + paginationRequired
				+ ", paginationRequestParamsData=" + paginationRequestParamsData + ", validateOrPreview="
				+ validateOrPreview + ", baseUrl=" + baseUrl + ", baseUrlRequired=" + baseUrlRequired
				+ ", paginationType=" + paginationType + ", soapBodyElement=" + soapBodyElement + "]";
	}
