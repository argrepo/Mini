...
public class Database {
	...
	public String toString() {
		return "Database [id=" + id + ", name=" + name + ", connector_id=" + connector_id + ", ids=" + ids + ", schema="
				+ schema + ", schemas=" + schemas + ", table=" + table + ", isActive=" + isActive + ", modification="
				+ modification + ", connectorName=" + connectorName + ", driverName=" + driverName + ", protocal="
				+ protocal + ", urlFormat=" + urlFormat + ", isDefault=" + isDefault + ", connectorJars="
				+ connectorJars + ", conJars=" + conJars + "]";
	}
